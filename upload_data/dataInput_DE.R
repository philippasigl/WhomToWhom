...
#rest of the world
nfc_row_debtSt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_nfc_debtSt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_debtSt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_debtSt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_debtSt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_debtSt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_debtSt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_ofi_debtSt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_debtSt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_icpf_debtSt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_debtSt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_govt_debtSt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.L.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_debtSt<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F3.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))

nfc_row_debtLt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_nfc_debtLt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_debtLt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_debtLt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_debtLt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_debtLt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_debtLt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_ofi_debtLt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_debtLt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_icpf_debtLt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_debtLt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_govt_debtLt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.L.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_debtLt<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F3.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))

nfc_row_loanSt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_nfc_loanSt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_loanSt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_loanSt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_loanSt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_loanSt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_loanSt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_ofi_loanSt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_loanSt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_icpf_loanSt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_loanSt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_govt_loanSt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.L.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_loanSt<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F4.S._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))

nfc_row_loanLt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_nfc_loanLt<-get_data("QSA.Q.N.DE.W0.S11.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_loanLt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_loanLt<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_loanLt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_loanLt<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_loanLt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_ofi_loanLt<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_loanLt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_icpf_loanLt<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_loanLt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_govt_loanLt<-get_data("QSA.Q.N.DE.W0.S13.S1.N.L.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_loanLt<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F4.L._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))

nfc_row_shares<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_nfc_shares<-get_data("QSA.Q.N.DE.W0.S11.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_shares<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_shares<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_shares<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_shares<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_shares<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_ofi_shares<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_shares<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_icpf_shares<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_shares<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_govt_shares<-get_data("QSA.Q.N.DE.W0.S13.S1.N.L.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_shares<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F511._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))

nfc_row_ivShares<-get_data("QSA.Q.N.DE.W0.S11.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
iv_row_ivShares<-get_data("QSA.Q.N.DE.W0.S124.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_iv_ivShares<-get_data("QSA.Q.N.DE.W0.S124.S1.N.L.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
mfi_row_ivShares<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
row_mfi_ivShares<-get_data("QSA.Q.N.DE.W0.S12K.S1.N.L.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
ofi_row_ivShares<-get_data("QSA.Q.N.DE.W0.S12O.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
icpf_row_ivShares<-get_data("QSA.Q.N.DE.W0.S12Q.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
govt_row_ivShares<-get_data("QSA.Q.N.DE.W0.S13.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
hh_row_ivShares<-get_data("QSA.Q.N.DE.W0.S1M.S1.N.A.LE.F52._Z._Z.XDC._T.S.V.N._T",filter=list(startPeriod=startPeriod,endPeriod=endPeriod))
